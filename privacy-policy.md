...
We respect your privacy and are committed to protecting your personal data. This Privacy Policy ("Policy") describes how we collect, use, store, protect, and disclose information when you use **any products, applications, games, websites, or services operated under the CQP.BET ecosystem** (collectively, the "Services").

These Services include, but are not limited to:
- **Crypto Quest**
- **Bust'a Gift**
- **Busto Games**
- Any current or future games, mini‑apps, web applications, or digital products published under the **CQP.BET** brand
...
- Timestamps, session duration, and interaction logs
- Gameplay statistics, events, and analytics data
- Technical logs related to performance, security, and fraud prevention

### User‑Provided Data
- Account identifiers (e.g., username, Telegram ID, wallet address)
- Game progress, achievements, inventory, and rewards
- In‑game transactions, purchases, and balance history
- Support requests and communications

### Social & Platform Data
If you connect a Service via third‑party platforms (such as Telegram, wallets, or platform SDKs), we may receive basic profile or account data in accordance with the permissions you grant and the platform’s privacy settings.
...
- Enable gameplay features, rewards, and progression systems
- Process in‑game transactions and virtual purchases
- Prevent abuse, cheating, fraud, and unauthorized access
- Analyze usage patterns to improve balance, performance, and user experience
...
- **Service Providers:** Infrastructure, analytics, payment, or hosting providers who process data strictly on our behalf and under confidentiality obligations.
- **Legal Requirements:** When disclosure is required to comply with applicable laws, regulations, or lawful requests.
- **Business Transfers:** In the event of a merger, acquisition, or asset transfer, user data may be transferred under equivalent privacy protections.
